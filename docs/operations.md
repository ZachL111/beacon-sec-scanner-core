...
`beacon-sec-scanner-core` is centered on security tooling work in PHP. The technical target is: Implement a PHP security tooling project for scanner constraint solving, using bounded scenario files and conflict explanations.
...
The score is deterministic. The current threshold is 164. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 2.
