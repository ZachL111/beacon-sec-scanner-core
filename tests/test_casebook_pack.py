"""Regression checks for the beacon-sec-scanner-core casebook."""
...
from casebook.harness import assert_expected, beacon_sec_scanner_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_sec_scanner_core_summary(), assert_expected())
